      ...
      <div className="container">
        <div className="content">
          <div className="content-item">
            ...
            <ul>
              <li>
                <Link to={PATH.ABOUT}>Về CFD Circle</Link>
              </li>
              <li>
                <Link to={PATH.COURSES}>Khóa học</Link>
              </li>
              <li>
                <Link to={PATH.BLOG}>Bài viết</Link>
              </li>
            </ul>
          </div>
          <div className="content-item">
            ...
            <ul>
              <li>
                <Link to={PATH.CONTACT}>Trung tâm hỗ trợ</Link>
              </li>
              <li>
                <Link to={PATH.PAYMENTMETHOD}>Phương thức thanh toán</Link>
              </li>
              <li>
                <Link to={PATH.PRIVACY}>Chính sách và điều khoản</Link>
              </li>
            </ul>
          </div>
          <div className="content-item">
